                        ...
                        children: [
                          ...
                          DropdownButton<int>(
                            ...
                            items: List.generate(15, (i) => i)
                                ...
                                .toList(),
                            onChanged: (val) => setStateDialog(() => diasAntes = val ?? 3),
                          ),
                          const Text(' antes'),
                        ],
                      ),
            ...
            actions: [
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  final desc = descController.text.trim().split(' ').map((p) => p.isEmpty ? '' : '${p[0].toUpperCase()}${p.substring(1).toLowerCase()}').join(' ');
